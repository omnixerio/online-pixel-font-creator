...
const COLOR_PRIMARY_DARK = "#ff6020";
const COLOR_PRIMARY_LIGHT = "#ff8030";
const COLOR_ALT_DARK = "#ff6020";
const COLOR_ALT_LIGHT = "#ff8030";
const COLOR_GRAY_LIGHT = "#404040";
const COLOR_GRAY_MEDIUM = "#333333";
const COLOR_GRAY_DARK = "#262626";
const COLOR_BLACK = "#e0e0e0";
const COLOR_WHITE = "#101010";

const COLOR_BG = COLOR_GRAY_MEDIUM;
const COLOR_PIXEL_WHITE = COLOR_WHITE;
const COLOR_PIXEL_BLACK = "#e0e0e0";
const COLOR_GRID = "#808080";
